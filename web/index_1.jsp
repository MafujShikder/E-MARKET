                        ...
                        <div class="widget">
                            ...
                            <div id="accordion">
                                ...
                                <ul class="clearfix">
                                        ...
                                        %>
                                        <li>
                                            <input type="button" id="<%=rs1.getString("id")%>" value="<%=rs1.getString("cn")%>" onclick="show(<%=rs1.getString("id")%>)" />
...
<!--                                                <a href="#"><%=rs11.getString("pi")%></a>-->
            ...
            <div class="detail">
                ...
                <div class="icon">
                    ...
                    <a href="cart-controller.jsp?action=insert&id=<%=rs11.getString("id")%>" class="two tooltip " title="Add to cart"></a>
                    <a href="show-cart.jsp?id=<%=rs11.getString("id")%>" class="three tooltip" title="Add to compare"></a>
                </div>
            </div>
