				...
				<div class="box span12">
					...
					<div class="box-content">
                        ...
                        try {
                            ...
                            ps2 = (PreparedStatement) connection4.prepareStatement("select *  from  companyaddproduct");
							...
							<tr>
								...
								<td class="center">
									<% String publishStatus = rs11.getString("ps1");
                                                   ...
                                                   %>
                                                <a class="btn btn-danger" href="publish-action.jsp?id=<%=rs11.getString("id")%>&scope=p&publishStatus=<%=rs11.getString("ps1")%>">
                                                ...
                                                %><a class="btn btn-success" href="publish-action.jsp?id=<%=rs11.getString("id")%>&publishStatus=<%=1%>&scope=p">
                                                    <i class="icon-zoom-in icon-white"></i>  
                                                    ...
                                                    <a class="btn btn-primary" href="feature-action.jsp?id=<%=rs11.getString("id")%>&status=<%=feature%>">
									...
									<a class="btn btn-danger" href="Manage_product_delete_action.jsp?id=<%=rs11.getString("id")%>">
