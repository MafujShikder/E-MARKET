	...
	<!-- topbar ends -->
      ...
      String id = request.getParameter("id");
                        ...
                        try {
                            ...
                            PreparedStatement ps2 = (PreparedStatement) connection4.prepareStatement("select *  from  adminaddmanufacturer WHERE id="+id);
                            ResultSet rs11 = ps2.executeQuery();
                            while (rs11.next()) {
                    %>
						<form class="form-horizontal" method="post" action="edit-action.jsp?id=<%=rs11.getString("id")%>&target=manufacturer">
						  <fieldset>
...
form.submit();
							...
							<div class="control-group">
							  ...
							  <div class="controls">
                                                              <input type="text" name="cn" value="<%=rs11.getString("cn")%>" class="span6 typeahead" id="typeahead" >
							...
							<div class="control-group">
							  ...
							  <div class="controls">
								<textarea name="cd" value="<%=rs11.getString("cd")%>" class="cleditor" id="textarea2" rows="3"><%=rs11.getString("cd")%></textarea><%=rs11.getString("cd")%>
							  </div>
							</div>
                                                      <div class="control-group">
