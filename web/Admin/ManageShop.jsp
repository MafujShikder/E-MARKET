		...
		<div class="row-fluid">
			...
			<div class="row-fluid sortable">		
				<div class="box span12">
						...
						<h2><i class="icon-edit"></i>Member</h2>
						<div class="box-icon">
					...
					<div class="box-content">
                        ...
                        try {
                            ...
                            while (rs11.next()) {
                    %>
						  <tbody><% String state = rs11.getString("state"); %>
							<tr>
								<td><%=rs11.getString("id")%></td>
								<td class="center"><%=rs11.getString("fname")%></td>
								<td class="center"><%=rs11.getString("email")%></td>
                                                                <td class="center"><%=rs11.getString("phone")%></td>
								<td class="center">
                                                                    <% if(state.equals("1")){
								...
								<%  
                                                                    if(state.equals("1")){
                                                                    %>
                                                                    <a class="btn btn-danger" href="shop-controller.jsp?action=toogle&id=<%=rs11.getString("id")%>&state=1">
										...
										Ban                                          
                                                                        ...
                                                                        <a class="btn btn-success" href="shop-controller.jsp?action=toogle&id=<%=rs11.getString("id")%>&state=0">
