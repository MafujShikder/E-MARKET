	...
	<!-- topbar ends -->
      ...
      String id = request.getParameter("id");
                        ...
                        try {
                            ...
                            PreparedStatement ps2 = (PreparedStatement) connection4.prepareStatement("select *  from  adminaddcategory WHERE id="+id);
                            ResultSet rs11 = ps2.executeQuery();
                            while (rs11.next()) {
                    %>
						<form class="form-horizontal" method="post" action="edit-action.jsp?id=<%=rs11.getString("id")%>&target=category">
						  <fieldset>
...
form.submit();
							...
							<div class="control-group">
							  ...
							  <div class="controls">
								<textarea name="discription" value="<%=rs11.getString("cd")%>" class="cleditor" id="textarea2" rows="3"></textarea><%=rs11.getString("cd")%>
							  </div>
							</div>
                                                      <div class="control-group">
