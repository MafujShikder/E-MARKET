            ...
            <div class="row-fluid">
                ...
                <div id="content" class="span10">
                    ...
                    <div class="row-fluid sortable">
						...
						<h2><i class="icon-edit"></i> Manage Category</h2>
						<div class="box-icon">
...
<!--                        <script>
              ...
              $(document).ready(function(deletecategory(id)){
                                        ...
                                        <tr>
                                            ...
                                            <td class="center">
                                                ...
                                                <% String publishStatus = rs11.getString("ps1");
                                                   ...
                                                   %>
                                                <a class="btn btn-danger" href="publish-action.jsp?id=<%=rs11.getString("id")%>&publishStatus=<%=0%>&scope=c">
                                                ...
                                                %>
                                                <a class="btn btn-success" href="publish-action.jsp?id=<%=rs11.getString("id")%>&publishStatus=<%=1%>&scope=c">
                                                    <i class="icon-zoom-in icon-white"></i>  
                                                                                             
                                                </a>
                                                <% } 
                                                %>
                                                <a class="btn btn-info" href="Manage_category_edit.jsp?id=<%=rs11.getString("id")%>">
                                                    <i class="icon-edit icon-white"></i>  
                                                                                         
                                                </a>
     
      
                                                  <a class="btn btn-danger" href="Manage_Category_delete_product_action.jsp?id=<%=rs11.getString("id")%>">
