			...
			<div class="container-fluid">
				...
				<div class="btn-group pull-right" >
					...
					<ul class="dropdown-menu">
						...
						<li class="divider"></li>
						<li><a href="AdminPanellogin.jsp">Logout</a></li>
					</ul>
				</div>
				<!-- user dropdown ends -->
			...
			<div class="row-fluid sortable">
				<div class="box span12">
					...
					<div class="box-content">
									<form class="form-horizontal" method="post" action="adminaddmanufactureraction.jsp">
						  <fieldset>
...
form.submit();
							...
							<div class="control-group">
							  ...
							  <div class="controls">
								<input type="text" name="cn" class="span6 typeahead" id="typeahead"  data-provide="typeahead" data-items="4" data-source='["Alabama","Alaska","Arizona","Arkansas","California","Colorado","Connecticut","Delaware","Florida","Georgia","Hawaii","Idaho","Illinois","Indiana","Iowa","Kansas","Kentucky","Louisiana","Maine","Maryland","Massachusetts","Michigan","Minnesota","Mississippi","Missouri","Montana","Nebraska","Nevada","New Hampshire","New Jersey","New Mexico","New York","North Dakota","North Carolina","Ohio","Oklahoma","Oregon","Pennsylvania","Rhode Island","South Carolina","South Dakota","Tennessee","Texas","Utah","Vermont","Virginia","Washington","West Virginia","Wisconsin","Wyoming"]'>
							...
							<div class="control-group">
							  ...
							  <div class="controls">
								<textarea name="cd" class="cleditor" id="textarea2" rows="3"></textarea>
							  </div>
							</div>
                                                      <div class="control-group">
								...
								<div class="controls">
								  <select name="ps1" id="selectError3">
									<option value="Select Publication Status">Select Publication Status</option>
