			...
			<div>
				<ul class="breadcrumb">
                    ...
                    <div class="row-fluid sortable">		
						...
						<h2><i class="icon-edit"></i> Manage Manufacturer</h2>
						<div class="box-icon">
                                        ...
                                        <tr>
                                           ...
                                           <td class="center">
                                               ...
                                               <% String publishStatus = rs11.getString("ps1");
                                                   ...
                                                   %>
                                                <a class="btn btn-danger" href="publish-action.jsp?id=<%=rs11.getString("id")%>&scope=m&publishStatus=<%=rs11.getString("ps1")%>">
                                                ...
                                                %><a class="btn btn-success" href="publish-action.jsp?id=<%=rs11.getString("id")%>&publishStatus=<%=1%>&scope=m">
                                                    <i class="icon-zoom-in icon-white"></i>  
                                                ...
                                                <a class="btn btn-info" href="edit-manufacturer.jsp?id=<%=rs11.getString("id")%>">
                                                  ...
                                                  <a class="btn btn-danger" href="Manage_manufacturer_delete_product_action.jsp?id=<%=rs11.getString("id")%>">
