...
form.submit();
                                    ...
                                    <h5><small>>>>>></small><a href="#">COMPANY INFORMATION</a></h5>

                                    <div class=" clearfix">
                                        <form class="billing-form clearfix" method="post" action="companysignupaction.jsp">
                                            <fieldset >
                                                <label>Company name</label>
                                                <input type="text"name="fname" placeholder="Enter Your Company Name"/>
                                            ...
                                            <input type="submit" value="continue" class="red-button" onClick="Confirm(this.form)" >
