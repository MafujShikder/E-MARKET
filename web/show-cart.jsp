...
editing starts here
                            <% String toShow = (String)session.getAttribute("cart");
          String[] cartItems = toShow.split(",");
     ...
     // String id = request.getParameter("id");
      String id = cartItems[i];
      System.out.println("Item in processing is: "+id);
                    ...
                    %>
                                    ...
                                    <ul class=" clearfix">
                                        <li>
                                            <figure><img src="images/product_images/<%=rs11.getString("pi")%>" alt=""></figure>
                                        </li>
                                        <li class="second">
                                        ...
                                        <li>BDT:<%=rs11.getString("pp")%></li>
                                        <li>$255.00</li>
                                        <li class="last"><input onclick="updatePrice()" name="btn btn-default" value="UPDATE" type="submit"/></li>
                                        <li><a href="/E-MARKET/show-cart.jsp?clear=<%=rs11.getString("id")%>">clear</a></li>
                                    </ul>
